package com.sledz.sledzinstruments.client.gui.instrument.harmonica;
...
@OnlyIn(Dist.CLIENT)
public class HarmonicaScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(SIMain.MODID, "harmonica");

    @Override
    public NoteSound[] getInitSounds() {
        return ModSounds.HARMONICA;
    }
